...
import {fetchMisas} from './services/misasServises';
import type {Misa} from './services/misasServises';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 h-full">
            <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-2xl shadow-xl p-8 flex flex-col ">
              ...
              <div className="flex-1 flex flex-col justify-center space-y-6">
               {Array.isArray(misas) && misas.map((misa)  => (
                  <div key={misa.id} className="text-center p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors duration-200">
            ...
            <div className="bg-white bg-opacity-90 backdrop-blur-sm rounded-2xl shadow-xl p-8 flex flex-col ">
              ...
              <div className="flex-1 flex flex-col justify-center space-y-8">
                {eventoSemanales.map((schedule, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="text-center">
            <p className="text-lg font-medium mb-2">
              <span className="font-bold">Dirección:</span> Km 7 ½ acaray, Ciudad del Este
            </p>
